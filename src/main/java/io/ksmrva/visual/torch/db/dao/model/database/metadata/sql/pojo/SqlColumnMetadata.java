...
public class SqlColumnMetadata {
    ...
    public SqlColumnMetadata(String columnName, String columnDescription, int sqlDataTypeValue, boolean isNullable, boolean isAutoIncrement, int ordinalPosition) {
    ...
    public static SqlColumnMetadata build(String columnName, String columnDescription, int sqlDataTypeValue, String isNullableDeclaration, String isAutoIncrementDeclaration, int ordinalPosition) {
        ...
        return new SqlColumnMetadata(columnName, columnDescription, sqlDataTypeValue, isNullable, isAutoIncrement, ordinalPosition);
    }
