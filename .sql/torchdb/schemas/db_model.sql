...
COMMENT ON SCHEMA db_model_source
    IS 'Entities that define Sources of Database information, which can then be used to create Database Model Details';
...
COMMENT ON SCHEMA db_model_detail
    IS 'Entities used to create Documentation elements that model a Database';
